...
function Teamlist() {
  return (
    <div>
      <h3>Information about the teams</h3>
      {Teams.map((oneTeam) => (
        <Team {...oneTeam} />
      ))}
    </div>
...
function App() {
  return (
    <div className="App">
      <h1>Welcome to Ethan's Website</h1>
      <p>
